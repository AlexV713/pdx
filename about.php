    ...
    <div id="wrapper">
        ...
        <main>
            ...
            <p class="bio">I am Jose Valerio (owner) and I've been working as a Handyman for more than 30 years now! I
                ...
                back
                in
                Mexico, and after I moved here to the U.S, I created my own business!</p>

            <h3 class="headings">Where I Work</h3>
            <p class="bio">I work in all Cornelius, Hillsboro, Beaverton, Aloha, Tigard, Newberg, Tillamook, Lincoln
                City, Oregon City, Portland, McMinnville, Lake Oswego, and Vancouver WA.</p>
